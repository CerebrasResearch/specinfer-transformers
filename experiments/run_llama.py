...
if __name__ == '__main__':
    ...
    llm_paths = ["/cb/home/abhay/extra-storage/sparse_inference/sharing/qc/spec_infer_demo/llama2_134M_ift"
                # "/net/extradisks1/srv/nfs/abhay-extra-data/sparse_inference/sharing/qc/spec_infer_demo/llama2_7B_ift", 
    ...
    ssm_paths = [
                "/cb/home/abhay/extra-storage/sparse_inference/sharing/qc/spec_infer_demo/llama2_115M_ift",
            ...
            for ssm, ssm_path in zip(ssms, ssm_paths):
                ...
                for llm_generation_config, ssm_generation_config in configs:
                    ...
                    for prompt in prompts:
                        ...
                        # ground truth from target model: a b c d e f g
                        # verification: a b c x f f y
                        # draft model: a b c x e f y
